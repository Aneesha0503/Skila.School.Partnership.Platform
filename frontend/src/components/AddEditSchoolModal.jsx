  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-3xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in duration-200">
        ...
        {/* Tab selection */}
        <div className="flex items-center gap-1 px-5 pt-3 bg-slate-100 border-b border-slate-200 text-xs font-semibold overflow-x-auto">
          <button
            onClick={() => setActiveTab('hierarchy')}
            className={`py-2 px-3 rounded-t-lg transition flex items-center gap-1.5 ${activeTab === 'hierarchy' ? 'bg-white text-indigo-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'}`}
          >
            <MapPin className="w-3.5 h-3.5" /> 1. Hierarchy
          </button>
          <button
            onClick={() => setActiveTab('info')}
            className={`py-2 px-3 rounded-t-lg transition flex items-center gap-1.5 ${activeTab === 'info' ? 'bg-white text-indigo-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'}`}
          >
            <Building2 className="w-3.5 h-3.5" /> 2. School Info
          </button>
          <button
            onClick={() => setActiveTab('tech')}
            className={`py-2 px-3 rounded-t-lg transition flex items-center gap-1.5 ${activeTab === 'tech' ? 'bg-white text-indigo-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'}`}
          >
            <Cpu className="w-3.5 h-3.5" /> 3. Technology
          </button>
          <button
            onClick={() => setActiveTab('sales')}
            className={`py-2 px-3 rounded-t-lg transition flex items-center gap-1.5 ${activeTab === 'sales' ? 'bg-white text-indigo-600 shadow-xs' : 'text-slate-600 hover:text-slate-900'}`}
          >
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 text-xs space-y-4">
          {errorMsg && (
            <div className="p-3 rounded-lg bg-rose-50 text-rose-700 border border-rose-200 font-medium">
              {errorMsg}
            </div>
          )}
          ...
          {activeTab === 'hierarchy' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Revenue Division / Sub-Division</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Mandal</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Local Body Type</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Local Body Name</label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label className="block text-slate-700 font-semibold mb-1">Village / Locality / Ward</label>
                <input
                  type="text"
          ...
          {activeTab === 'info' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">UDISE Code (11 digits) *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Affiliated Board</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">School Category</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Teacher Strength</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Correspondent Name</label>
                <input
                  type="text"
          ...
          {activeTab === 'tech' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-slate-700 font-semibold mb-1">ERP Used?</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">ERP Vendor</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">LMS Used?</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">LMS Vendor</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Coding Curriculum?</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Robotics Program?</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">ATL Lab Established?</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Smart Classroom Count</label>
                <input
                  type="number"
          ...
          {activeTab === 'sales' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Key Decision Maker</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Annual Fee Range</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Skila AI Potential</label>
                <select
              ...
              <div>
                <label className="block text-slate-700 font-semibold mb-1">Sales Owner</label>
                <input
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label className="block text-slate-700 font-semibold mb-1">Remarks & Strategy Notes</label>
                <textarea
                  rows="3"
          ...
          <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-5 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-xs"
            >
